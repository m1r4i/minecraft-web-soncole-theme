  ...
  $.ajax('../../theme.php',
      {
        ...
        <div class="example">
         ...
         <li class="active"><a href="#">
                           ...
                           <div class="cell-md-6">
                    <div data-role="panel" data-title-icon="<span class='mif-apps'></span>" data-title-caption="確認メールを送信しました" data-collapsible="true">
        <h3>念のため迷惑メールボックスもご確認ください。 </h3><br><br><h5>それでもまだ届かない場合やメールアドレスを変更したい場合はもう一度最初からやり直してください
 </h5></div>
    </div>
                </div>
    <script src="../../js/jquery-3.3.1.min.js"></script>
