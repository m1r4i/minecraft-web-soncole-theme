  ...
  $.ajax('../../theme.php',
      {
        ...
        <div class="example">
         ...
         <li class="active"><a href="#">
                           ...
                           <div class="cell-md-6">
                    <div data-role="panel" data-title-icon="<span class='mif-apps'></span>" data-title-caption="ようこそ!" data-collapsible="true">
        <h3>Webconsoleへようこそ! ログインしてください!</h3><br><br>
<a href="../../../signin"><button type="submit" class="command-button" style="margin:30%; margin-top:25px; margin-bottom:25px;">
                    <span class="mif-user icon"></span>
                    <span class="caption">
                        ログイン                        <small>ログインして続行</small>
                    </span>
                </button>  </a>
